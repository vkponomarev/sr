...
class Pages extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['sort'], 'integer'],
            [['embed'], 'integer'],
            [['products_brand'], 'integer'],
            [['products_carrying'], 'integer'],
            [['products_motor'], 'integer'],
            [['products_type'], 'integer'],
            [['products_type_second'], 'integer'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'products_carrying' => 'products_carrying',
            'products_motor' => 'products_motor',
            'products_type' => 'products_type',
            'products_type_second' => 'products_type_second',
        ];
    }
